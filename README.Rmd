...
[![RMD Check](https://github.com/Fernandez-Lab-WSU/geocovidapp/actions/workflows/rmd-check.yaml/badge.svg)](https://github.com/Fernandez-Lab-WSU/geocovidapp/actions/workflows/rmd-check.yaml)
[![Coverage status](https://codecov.io/gh/Fernandez-Lab-WSU/geocovidapp/branch/main/graph/badge.svg)](https://codecov.io/gh/Fernandez-Lab-WSU/geocovidapp)
...
1. **Mapa**: En este tab se muestra un mapa de la provincia de Buenos Aires con los casos de Covid-19.
