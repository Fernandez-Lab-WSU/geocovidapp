               ...
               function(input, output, session) {
                ...
                # Click en el mapa de la provincia de BsAs permite acercarme al mapa
                 ...
                 observeEvent(boton(), {
                    ...
                    info_text(paste("Ubicación:", ifelse(area() == 'amba', "Área Metropolitana de Buenos Aires", "Buenos Aires"), 
                           "| Fecha:", fecha(), 
                 ...
                 # Actualiza el texto cuando cambia el área (además del botón de actualización)
